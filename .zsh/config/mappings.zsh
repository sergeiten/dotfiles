...
bindkey -M viins '^R' custom-fzf-launch-from-history # Select comand from history into the command line.
bindkey -M viins '^O' custom-fzf-select # Paste the selected files and directories into the command-line.
